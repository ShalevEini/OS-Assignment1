...
test_two_children_same_parent_target(void)
{
    ...
    if (c1 == 0) {
        ...
        if (v != 101) {
            printf("test_two_children_same_parent_target child1 failed: got %d\n", v);
            exit(1);
        }
        exit(0);
    }
    ...
    if (c2 == 0) {
        ...
        if (v != 201) {
            printf("test_two_children_same_parent_target child2 failed: got %d\n", v);
            exit(1);
        }
        exit(0);
    }
    ...
    if (r1 != 100 || r2 != 200) {
        printf("test_two_children_same_parent_target parent failed: r1=%d r2=%d\n", r1, r2);
        kill(c1);
        kill(c2);
        wait(0);
        wait(0);
